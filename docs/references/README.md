...
| [DOCKER.md](./DOCKER.md) | nginx, Docker, Coolify |
| [ACCESSIBILITY.md](./ACCESSIBILITY.md) | a11y für Timer-UI |

## Umsetzungsplan

→ [`../IMPLEMENTATION_PLAN.md`](../IMPLEMENTATION_PLAN.md)

## Cursor Rules (automatisch)

→ [`.cursor/rules/`](../../.cursor/rules/)

## Pflege

- Bei Stack-Upgrades: `STACK.md` + `EXTERNAL_DOCS.md` + betroffene Referenz aktualisieren
- Neue Konventionen: zuerst `CODING_STANDARDS.md`, dann passende `.mdc`-Rule
